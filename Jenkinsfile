                ...
                {  
                     sh '''
                        ...
                        yum install jq -y
                         ...
                         aws ecs update-service --cluster final-project-Cluster-Prod --service final-project-Service-Prod --task-definition final-project-TaskDefinition-Prod:$LATEST_TD_REVISION --no-wait-for-service-stability
                     '''
                 }
             }
         }
